...
let stage3 = [ //失敗
    ...
    { name: "地點", word: "（隔天，小開家道館）", image: "img/寶貝球.png", bEvent: 0 },
    { name: "你", word: " 下午好！不好意思打擾了抱歉昨天突然有急事沒辦法到…", image: "img/市長女兒/2.png", bEvent: 0 },
    { name: "小開", word: " 該不會你又去跑公務了吧？", image: "img/小開/0.png", bEvent: 0 },
...
let stage1_2_2_2_2_2 = [ //趕緊跟上 
    ...
    { name: "小開", word: "會的唷~畢竟我可是道館館主的兒子呢 ", image: "img/小開/4.png", bEvent: 0 },
    { name: "小開", word: "今天早上正好剛通過他的考驗呢", image: "img/小開/4.png", bEvent: 0 },
    { name: "小開", word: "有了他的支持，我對大賽更有信心了呢", image: "img/小開/3.png", bEvent: 0 },

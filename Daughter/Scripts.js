...
let stage1 = [
    ...
    { name: "市長", word: "女兒，今天也要麻煩你幫爸爸跑一下公務了 ", image: "img/市長.png", bEvent: 0 },
    ...
    { name: "市長", word: "阿就沒辦法啊…縣長突然說要增加項目… ", image: "img/市長.png", bEvent: 0 },
    { name: "你", word: "但是…", image: "img/市長女兒/2.png", bEvent: 0 },
    { name: "市長", word: "沒有什麼但不但是，可不可是的！！ ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "你既然未來想做市長的祕書，就要努力實習 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "別整天只想著和道館的小開玩 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "不是的女兒，爸爸是真的忙不過來 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "如果你不想做，那我就會給別人", image: "img/市長.png", bEvent: 1, event: Choice_stage1_0 },
]
...
let stage1_1 = [ //拒絕爸爸交代的事 
    ...
    { name: "市長", word: "好吧，那我就將這份工作交給別人了", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "不過女兒，我對你確實有點失望 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "首先，我希望你能學會為了未來著想 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "其次，你不該抱持這麼激烈的勝負欲 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "想贏的心能促使你進步 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: "但它的首要條件是你必須良性競爭 ", image: "img/市長.png", bEvent: 0 },
...
let stage1_2 = [ //接受爸爸交代的事
    ...
    { name: "市長", word: "這次縣長說要把城市的土地利用重新規劃 ", image: "img/市長.png ", bEvent: 0 },
    { name: "市長", word: "雖然很突然但我這次真的不太懂他的想法 ", image: "img/市長.png ", bEvent: 0 },
...
let stage1_2_1 = [ //護士 
    { name: "你", word: "喂？不好意思請問是神奇寶貝中心的護士喬伊小姐嗎？", image: "img/市長女兒/0.png", bEvent: 0 },
...
let stage1_2_2 = [ //流動商人
    ...
    { name: "哈密瓜", word: " 當然沒有問題啊！我可是鼎鼎大名的哈密瓜", image: "img/電話.png", bEvent: 0 },
    { name: "哈密瓜", word: " 無論是你想的到的或是想不到的東西我都有，我都會！", image: "img/電話.png", bEvent: 0 },
...
let stage1_2_2_2 = [ //找土地分析專家 
    ...
    { name: "土地分析專家", word: " 是的我是！請問找我有什麼事嗎？ ", image: "img/電話.png", bEvent: 0 },
    { name: "你", word: " 是這樣的市政府需要您的協助，不知道您是否有空呢？ ", image: "img/電話.png", bEvent: 0 },
    { name: "土地分析專家", word: " 能幫助您們我感到十分榮幸，剛好手上的研究到一個段落了！", image: "img/電話.png", bEvent: 0 },
    { name: "土地分析專家", word: " 我馬上過去 ", image: "img/電話.png", bEvent: 0 },
...
let stage1_2_2_2_2 = [ //不借 
    ...
    { name: "市長", word: " 不愧是我的女兒，這麼快就完成了，我等會兒看看，今天辛苦妳了", image: "img/市長.png", bEvent: 0 },
    ...
    { name: "市長", word: " 我知道你們從有神奇寶貝開始就會約彼此切磋了，爸爸也不會反對你們切磋", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: " 不過最近的頻率有點頻繁啊，所以爸爸以為你們是藉著切磋的名義出去玩。", image: "img/市長.png", bEvent: 0 },
    ...
    { name: "市長", word: " 神奇寶貝大賽？原來如此，沒想到女兒妳對這個有興趣", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: " 不過下次可以主動告訴爸爸，這樣爸爸才不會胡思亂想誤會你", image: "img/市長.png", bEvent: 0 },
    ...
    { name: "市長", word: " 當然呀，有夢想是最美好的一件事 ", image: "img/市長.png", bEvent: 0 },
    { name: "市長", word: " 更何況妳是我最優秀的女兒，我怎麼可能不支持妳 ", image: "img/市長.png", bEvent: 0 },
    { name: "你", word: " 太棒了，我一定會努力成為神奇寶貝大師的", image: "img/市長女兒/3.png", bEvent: 0 },
    { name: "市長", word: " 不過話說...為什麼偏偏是小開呢...你確定只是單純的想練習嗎？", image: "img/市長.png", bEvent: 0 },
    { name: "你", word: " 當...當然呀，這座城市除了他就沒有人能贏我了，不找他就沒有第二個人選了 ", image: "img/市長女兒/4.png", bEvent: 0 },
    { name: "市長", word: " 是這樣啊，那女兒妳安心準備，我最近就不派工作給妳了，好好努力啊，加油！ ", image: "img/市長.png", bEvent: 0 },
    ...
    { name: "小開", word: " 該不會你又去跑公務了吧？", image: "img/小開.png", bEvent: 0 },
    ...
    { name: "小開", word: " 算了你每次都這樣也不知道休息一下…都不知道我很擔心你… ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 嗯？剛剛說什麼？ ", image: "img/市長女兒/6.png", bEvent: 0 },
    { name: "小開", word: " 沒什麼啦！還不快點開始今天的比賽！ ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 真是的！你還不是一樣常常逃避我的問題… ", image: "img/市長女兒/1.png", bEvent: 0 },
    { name: "小開", word: " 你怎麼還在那裡？快點跟上，我們要去練習場了 ", image: "img/小開.png", bEvent: 0 },
...
let stage1_2_2_2_2_2 = [ //趕緊跟上 
    ...
    { name: "小開", word: "說什麼傻話呀！我們不是每個禮拜都會在一起練習嗎？ ", image: "img/小開.png", bEvent: 0 },
    { name: "小開", word: "最近為了大賽還更頻繁了，平日沒事時也都待在一塊… ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 呀！你不要破壞氣氛啦！被別人聽到會誤會的 ", image: "img/市長女兒/1.png", bEvent: 0 },
    { name: "小開", word: "又沒關係這是事實，我也不在乎別人怎麼說 ", image: "img/小開.png", bEvent: 0 },
    { name: "小開", word: "順帶一提大家貌似都覺得我們的感情很好！！ ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: "但是我很在乎呀！！！咦？大家都覺得？？等等大家都知道了？！ ", image: "img/市長女兒/1.png", bEvent: 0 },
    { name: "你", word: "你又再捉弄我了！我這次絕對會贏你！！ ", image: "img/市長女兒/1.png", bEvent: 0 },
    { name: "小開", word: "反正我們又沒做什麼虧心事，那我可要用盡全力了！ ", image: "img/小開.png", bEvent: 0 },
    { name: "", word: " （一段時間後） ", image: "", bEvent: 0 },
    { name: "你", word: "為什麼阿？又輸了… ", image: "img/市長女兒/2.png", bEvent: 0 },
    { name: "小開", word: "從小到大我都跟你待在一起，你的習慣我幾乎都知道", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: "咦…（看來回去的時候該去翻翻神奇寶貝攻略秘笈了） ", image: "img/市長女兒/6.png", bEvent: 0 },
    { name: "小開", word: "妳啊就是出招的時候太猶豫@＃*/-$還有啊＃$/@", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: "知道了知道了！你為什麼這麼了解我啊？", image: "img/市長女兒/3.png", bEvent: 0 },
    { name: "小開", word: "就…就妳怎麼突然問這種問題…我其實一直注意著妳 ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: "哪…哪有人講話這麼直接的！ ", image: "img/市長女兒/1.png", bEvent: 0 },
    { name: "小開", word: "不要逼我說出這種話啦 ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: "好啦停止這個話題", image: "img/市長女兒/4.png", bEvent: 0 },
    { name: "你", word: "今..今天道館怎麼這麼熱啊，我都出汗了，我們要不要去外面玩", image: "img/市長女兒/4.png", bEvent: 0 },
    { name: "你", word: "我們要不要去外面玩", image: "img/市長女兒/0.png", bEvent: 0 },
    { name: "小開", word: "嗯...好啊，今天的練習量已經夠了，我們走吧 ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 不過我們要去哪裡呀？ ", image: "img/市長女兒/0.png", bEvent: 0 },
    { name: "小開", word: "去附近逛逛看看風景放鬆一下心情", image: "img/小開.png", bEvent: 0 },
    { name: "", word: "（並肩一起走到到目的地）", image: "", bEvent: 0 },
    { name: "小開", word: "大賽快要開始了啊…有點緊張 ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 對了昨天呀爸爸同意讓我參加了耶！好開心喔！", image: "img/市長女兒/3.png", bEvent: 0 },
    { name: "小開", word: "真的嗎那真是太好了。 ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 你呢？你會參加的吧？", image: "img/市長女兒/3.png", bEvent: 0 },
    { name: "小開", word: "可能也會吧…我們家還蠻重視這個的畢竟是道館館主的兒子 ", image: "img/小開.png", bEvent: 0 },
    { name: "小開", word: "不過爸爸還在歷練我，他希望我可以以更好的實力上場 ", image: "img/小開.png", bEvent: 0 },
    { name: "小開", word: "但我一定會通過他的考驗，然後堂堂正正的站上神奇寶貝大賽的擂台！ ", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 那真是太好了，我一定會在大賽上打敗你，然後證明給大家看我也是很厲害的 ", image: "img/市長女兒/3.png", bEvent: 0 },
    { name: "小開", word: "其實你不用證明給大家看，大家其實一直覺得你很厲害…", image: "img/小開.png", bEvent: 0 },
    { name: "你", word: " 真的嗎？可是我每次都輸你 ", image: "img/市長女兒/2.png", bEvent: 0 },
    { name: "小開", word: "不是有句話說知己知彼百戰百勝嗎？我覺得你最缺少的是觀察對手的能力", image: "img/小開.png", bEvent: 1, event: Choice_stage1_2_2_2_2_2_0 },
]
...
let stage1_2_2_2_2_2_2 = [ //聽取小開的建議 
    ...
    { name: "小開", word: " 嗯能幫助到你我也很開心 ", image: "img/.png", bEv小開ent: 0 },
...
let stage1_2_2_2_2_2_2_2 = [ //邀請小開 
    ...
    { name: "小開", word: " 好呀！順道一起，剛好省下特地過來的時間 ", image: "img/小開.png", bEvent: 0 },

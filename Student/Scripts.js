let stage1 = [
    ...
    { name: "博士", word: "你來了啊~", image: "img/博士.png", bEvent: 0 },
    { name: "博士", word: "剛剛我做實驗做得太入迷了 ", image: "img/博士.png", bEvent: 0 },
    { name: "博士", word: "所以沒聽到敲門聲，不好意思啊 ", image: "img/博士.png", bEvent: 0 },
    { name: "博士", word: "進來吧，先跟你介紹我的新助理，他以前也是我的學生", image: "img/博士.png", bEvent: 0 },
    { name: "博士", word: "助理，你先停一下手邊的事，跟你介紹一下", image: "img/博士.png", bEvent: 0 },
    { name: "博士", word: "這是我現在的學生，剛剛的電話就是他打來的", image: "img/博士.png", bEvent: 0 },
    { name: "助理", word: "你好，我算是你的學長吧~", image: "img/飛行員/0.png", bEvent: 0 },
    { name: "你", word: "學長你好，我這次是來給博士看報告的", image: "img/學生/0.png", bEvent: 0 },
    { name: "你", word: "希望不會打擾到你做事", image: "img/學生/0.png", bEvent: 0 },
    { name: "助理", word: "哈哈沒事，我只是在整理東西而已", image: "img/飛行員/0.png", bEvent: 0 },
    { name: "助理", word: "依照我對博士的了解，他肯定會針對報告問你問題", image: "img/飛行員/4.png", bEvent: 0 },
    { name: "助理", word: "你可要加油啊", image: "img/飛行員/0.png", bEvent: 0 },
    { name: "你", word: "我會的！謝謝學長", image: "img/學生/0.png", bEvent: 0 },
    { name: "博士", word: "好了那讓我看看你的報告吧", image: "img/博士.png", bEvent: 0 },
    { name: "你", word: "請您過目。", image: "img/學生/0.png", bEvent: 1, event: bag_nothing },

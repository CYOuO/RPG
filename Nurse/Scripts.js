let stage1 = [
    ...
    { name: "你", word: "平常的工作就是照顧在戰鬥中受傷的神奇寶貝", image: "img/護士/1.png", bEvent: 0 },
    ...
    { name: "", word: "（陽光從窗口灑進房間）", image: "", bEvent: 0 },
...
let stage1_2_1 = [ //流動商人 
    ...
    { name: "你", word: "有的有的他可是那個哈密瓜耶那", image: "img/護士/3.png", bEvent: 0 },
    ...
    { name: "你", word: "但這個OK繃還有繃帶給你", image: "img/護士/0.png", bEvent: 0 },
    ...
    { name: "院長", word: "是你要好好加油阿！要為我們爭光喔", image: "img/院長/3.png", bEvent: 0 },
...
let stage1_2_1_1 = [ //忽視 
    ...
    { name: "地點", word: "（訓練場）", image: "", bEvent: 0 },
...
let stage1_2_1_2 = [ //尋找聲音來源 
    ...
    { name: "", word: "（再次回到神奇寶貝中心）", image: "", bEvent: 0 },
